                            ...
                            <div class="card-body">
                                <div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
                                    ...
                                    <div>
                                        ...
                                        @can('subject-edit')
                                        <a href="{{route('subjects.edit',$subject->id)}}" class="p-2">{{__('home.edit')}}<i class="fa-regular fa-pen-to-square p-2"></i></a>
                                        @endcan
                                        @can('subject-delete')
                                        <button onclick="return confirm('{{__('home.Are you sure to delete')}}');" class="p-2">{{__('home.delete')}}<i class="fa-regular fa-trash-can p-2"></i></button>
                                        @endcan
                                        {!! Form::close() !!}
                                    </div>
                                </div>
