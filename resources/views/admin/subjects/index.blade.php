                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h4 class="mb-0 fs-16 font-w500">{{$subject->name}}</h4>
                                            </div>
                                        </td>

                                        <td>{{$subject->created_at->translatedFormat('M d, Y')}}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-start">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('subjects.edit',$subject->id)}}">{{__('home.edit')}}</a>
                                                    {!! Form::close() !!}
                                                </div>
                                            </div>
                                        </td>
