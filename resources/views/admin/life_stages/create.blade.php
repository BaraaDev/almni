...
@inject('model','App\Models\LifeStage')
@section('title') {{__('life_stage.create life Stage') . $title}} @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('life_stage.create life Stage')}}</h4>
                    </div>

                    <div class="card-body">
                        @include('layouts.admin.alert.validation-errors')
                        <div class="basic-form">
                            <form class="needs-validation" id="alert-form" method="post" action="{{route('life-stages.store')}}" files="true" enctype="multipart/form-data" novalidate>
                                @csrf
                                @include('admin.life_stages.form')
