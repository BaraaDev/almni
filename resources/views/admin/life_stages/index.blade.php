            ...
            <div class="col-xl-12">
                ...
                <div class="card students-list">
                    <div class="card-header border-0 flex-wrap pb-0">
                        <h4>{{__('life_stage.all life Stages')}}</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h4 class="mb-0 fs-16 font-w500">{{$life_stage->stage}}</h4>
                                            </div>
                                        </td>

                                        <td>{{$life_stage->description}}</td>
                                        <td>{{$life_stage->created_at->translatedFormat('M d, Y')}}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-start">
                                                    {!! Form::open([
                                                        'route' => ['life-stages.destroy',$life_stage->id],
                                                        'method' => 'delete'
                                                    ])!!}
                                                    @can('life-stage-delete')
                                                    <button class="dropdown-item" onclick="return confirm('{{__('home.Are you sure to delete')}}');"  type="submit">{{__('home.delete')}}</button>
                                                    @endcan
                                                    @can('life-stage-edit')
                                                    <a class="dropdown-item" href="{{route('life-stages.edit',$life_stage->id)}}">{{__('home.edit')}}</a>
                                                    @endcan
                                                    {!! Form::close() !!}
                                                </div>
                                            </div>
