...
@section('title') {{__('expenses.all expenses') . $title}} @endsection
        ...
        <div class="col-xl-12">
            ...
            <div class="card students-list">
                <div class="card-header border-0 flex-wrap pb-0">
                    <h4>{{__('expenses.all expenses')}}</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table display mb-4 dataTablesCard order-table card-table text-black application" id="application-tbl1">
                            ...
                            <tr>
                                ...
                                <th>{{__('expenses.price')}}</th>
                                <th>{{__('expenses.count')}}</th>
                                <th>{{__('user.user')}}</th>
                            ...
                            @forelse($expenses as $expense)
                                <tr>
                                    ...
                                    <td>
                                        <h4 class="mb-0 fs-16 font-w500">{{$expense->title}}</h4>
                                    </td>
                                    <td>{{$expense->price}}</td>
                                    <td>{{$expense->count}}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-start">
                                                ...
                                                @endcan
                                                @can('expenses-edit')
                                                    <a class="dropdown-item" href="{{route('expenses.edit',$expense->id)}}">{{__('home.edit')}}</a>
                                                @endcan
                                                {!! Form::close() !!}
                                            </div>
                                        </div>
