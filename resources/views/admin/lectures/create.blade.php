...
@inject('model','App\Models\Lecture')
@section('title') {{__('lecture.create lectures') . $title}} @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('lecture.create lecture')}}</h4>
                    </div>

                    <div class="card-body">
                        @include('layouts.admin.alert.validation-errors')
                        <div class="basic-form">
                            <form class="needs-validation" id="alert-form" method="post" action="{{route('lectures.store')}}" files="true" enctype="multipart/form-data" novalidate>
                                @csrf
