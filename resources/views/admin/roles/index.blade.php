...
@section('title') {{__('role.all Roles') . $title}} @endsection
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h4 class="mb-0 fs-16 font-w500">{{$role->name}}</h4>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-start">
                                                    ...
                                                    @endcan
                                                        @can('role-edit')
                                                            <a class="dropdown-item" href="{{route('roles.edit',$role->id)}}">{{__('home.edit')}}</a>
                                                        @endcan
                                                    {!! Form::close() !!}
                                                </div>
                                            </div>
