                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h4 class="mb-0 fs-16 font-w500">{{$city->city}}</h4>
                                            </div>
                                        </td>

                                        <td>({{ $city->users->count()}}) @foreach($city->users->slice(0,2) as $city) - {{$city->name}}@endforeach</td>

                                        <td>{{$city->created_at->translatedFormat('M d, Y')}}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-start">
                                                    ...
                                                    @endcan
                                                    @can('city-edit')
                                                    <a class="dropdown-item" href="{{route('cities.edit',$city->id)}}">{{__('home.edit')}}</a>
                                                    @endcan
                                                    {!! Form::close() !!}
                                                </div>
                                            </div>
