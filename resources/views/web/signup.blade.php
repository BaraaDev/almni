...
<!-- Mirrored from creativelayers.net/themes/educrat-html/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jul 2022 22:21:37 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="UTF-8">
                        ...
                        <div class="row justify-center items-center">
                            <div class="col-xl-8 col-lg-9">
                                <div class="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
                                    <h3 class="text-30 lh-13">{{__('home.signup')}}</h3>
                                    <p class="mt-10">Already have an account? <a href="{{route('signin')}}" class="text-purple-1">{{__('home.signin')}}</a></p>

                                    <form class="contact-form respondForm__form row y-gap-20 pt-30" method="POST" action="{{ route('register') }}">
                                        @csrf
                                        <div class="col-lg-12">
                                            <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">{{__('user.name')}}</label>
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" required name="name" placeholder="{{__('user.Enter the full name')}}" value="{{old('name')}}">
                                            @error('name')
                                        ...
                                        <div class="col-lg-12">
                                            <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">{{__('user.Confirm Password')}}</label>
                                            <input type="password" class="form-control" required name="password_confirmation" placeholder="{{__('user.Re-enter the password')}}">
                                        </div>
                                        <div class="col-12">
