            ...
            <div class="row">
                <div class="col-auto">
                    <div class="breadcrumbs__content">
                        ...
                        <div class="breadcrumbs__item">
                            <a href="{{route('course',$category->slug)}}">{{$category->name}}</a>
                        </div>
                ...
                <div class="row">
                    <div class="col-auto">
                        <div data-anim="slide-up delay-1">
                            <h1 class="page-header__title">{{__('category.category'). ' ' . ($category->name)}}</h1>
                        </div>
...
--}}
            <div class="accordion__item">
                <div class="row y-gap-20 pb-30 items-center justify-between">
                    <div class="col-auto">
                        <div class="text-14 lh-12">{{__('home.Showing')}} <span class="text-dark-1 fw-500">{{$category->courses->count()}}</span>
                        </div>
                    </div>
                </div>
            </div>
