...
@section('title') {{__('question.edit format') . ' ' . $format->title }} @endsection
@section('content')
                    ...
                    <div class="col-12">
                        <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                            ...
                            <div class="py-30 px-30">
                                <form class="contact-form row y-gap-30" action="{{route('formats.update',$format->id)}}" method="post">
                                    @csrf
                                    {{ method_field('put') }}
                                    ...
                                    <div class="row y-gap-20 justify-between pt-15">
                                        <div class="col-auto">
                                            <button type="submit" class="button -md -purple-1 text-white">{{__('home.edit')}}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
