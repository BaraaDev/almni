...
@section('title') {{__('question.format') . ' ' . $format->title}} @endsection
            ...
            <div class="dashboard__content bg-light-4">
                <div class="row pb-50 mb-10">
                    <div class="col-auto">
                        ...
                        <h1 class="text-30 lh-12 fw-700">{{__('question.format') . ' ' . $format->title}}</h1>
                        ...
                        <div class="breadcrumbs mt-10 pt-0 pb-0">
                            <div class="breadcrumbs__content">
                                ...
                                <div class="breadcrumbs__item">
                                    <a href="javascript:void(0);">{{$format->title}}</a>
                                </div>
                            </div>
                        </div>
