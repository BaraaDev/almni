...
@inject('option','App\Models\QuestionsOption')

@section('title') {{__('question.add new option')}} @endsection
@section('content')
        ...
        <div class="dashboard__main">
            <div class="dashboard__content bg-light-4">
                <div class="row pb-50 mb-10">
                    <div class="col-auto">
                        <h1 class="text-30 lh-12 fw-700">{{__('question.add new option')}}</h1>
                    ...
                    <div class="col-12">
                        <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                            ...
                            <div class="py-30 px-30">
                                <form class="contact-form row y-gap-30" action="{{route('options.index')}}" method="post">
                                    @csrf
