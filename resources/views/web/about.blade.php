        ...
        <div class="container">
            ...
            <div class="row y-gap-30 justify-between pt-60 lg:pt-40">
                <div class="col-xl-2 col-lg-3 col-md-6">
                    <div class="d-flex flex-column items-center text-center">
                        <div class="relative size-120 d-flex justify-center items-center rounded-full bg-light-4">
                            <img src="{{asset('web/img/home-3/works/1.svg')}}" alt="image">
                ...
                <div class="col-xl-2 col-lg-3 col-md-6">
                    <div class="d-flex flex-column items-center text-center">
                        <div class="relative size-120 d-flex justify-center items-center rounded-full bg-light-4">
                            <img src="{{asset('web/img/home-3/works/2.svg')}}" alt="image">
                            <div class="side-badge">
                                <div class="size-35 d-flex justify-center items-center rounded-full bg-dark-1 -dark-bg-purple-1">
                ...
                <div class="col-xl-2 col-lg-3 col-md-6">
                    <div class="d-flex flex-column items-center text-center">
                        <div class="relative size-120 d-flex justify-center items-center rounded-full bg-light-4">
                            <img src="{{asset('web/img/home-3/works/3.svg')}}" alt="image">
                            <div class="side-badge">
                                <div class="size-35 d-flex justify-center items-center rounded-full bg-dark-1 -dark-bg-purple-1">
                            ...
                            <div class="swiper-slide h-100">
                                <div data-anim="slide-up" class="testimonials -type-2 text-center">
                                    <div class="testimonials__icon">
                                        <img src="{{asset('web/img/misc/quote.svg')}}" alt="quote">
                                    </div>
                            ...
                            <div class="pagination -avatars row x-gap-40 y-gap-20 justify-center js-testimonials-pagination">
                                ...
                                <div class="col-auto">
                                    <div class="pagination__item is-active">
                                        <img src="{{asset('web/img/home-3/testimonials/1.png')}}" alt="image">
                                    </div>
                                </div>

                                <div class="col-auto">
                                    <div class="pagination__item ">
                                        <img src="{{asset('web/img/home-3/testimonials/2.png')}}" alt="image">
                                    </div>
                                </div>

                                <div class="col-auto">
                                    <div class="pagination__item ">
                                        <img src="{{asset('web/img/home-3/testimonials/3.png')}}" alt="image">
                                    </div>
                                </div>

                                <div class="col-auto">
                                    <div class="pagination__item ">
                                        <img src="{{asset('web/img/home-3/testimonials/4.png')}}" alt="image">
                                    </div>
                                </div>

                                <div class="col-auto">
                                    <div class="pagination__item ">
                                        <img src="{{asset('web/img/home-3/testimonials/5.png')}}" alt="image">
                                    </div>
                                </div>
            ...
            <div class="row y-gap-30 justify-between items-center">
                ...
                <div class="col-lg-6 lg:order-1">
                    <div class="composition -type-3">
                        ...
                        <div class="-el-2">
                            <img class="w-1/1" src="{{asset('web/img/home-6/learn/1.png')}}" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row y-gap-30 items-center">
                <div class="col-xl-5 offset-xl-1 col-lg-6">
                    <img class="w-1/1" src="{{asset('web/img/home-2/about/1.png')}}" alt="image">
                </div>
        ...
        <div class="container">
            <div class="row y-gap-30 items-center">
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6 order-lg-2 order-1">
                    <img class="w-1/1" src="{{asset('web/img/home-2/about/2.png')}}" alt="image">
                </div>
            </div>
        </div>
    </section>
